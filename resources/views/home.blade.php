                    ...
                    <div class="col-8">
                        <div class="numbers">
                            ...
                            <h5 class="font-weight-bolder mb-0">
                              @php
                                  try {
                                    echo 'Rs '.number_format($data->present_payment);
                                  } catch (Exception $e){
                                    echo 'Rs 0';
                                  }
                              @endphp
                                {{-- Rs {{ number_format($data->present_payment) }} --}}
                    ...
                    <div class="col-8">
                        <div class="numbers">
                            ...
                            <h5 class="font-weight-bolder mb-0">
                              @php
                                  try {
                                    echo 'Rs '.number_format($data->total_payment);
                                  } catch (Exception $e){
                                    echo 'Rs 0';
                                  }
                              @endphp
                    ...
                    <div class="col-8">
                        <div class="numbers">
                            ...
                            <h5 class="font-weight-bolder mb-0">
                              @php
                                  try {
                                    echo 'Rs '.number_format($data->today_payment);
                                  } catch (Exception $e){
                                    echo 'Rs 0';
                                  }
                              @endphp
                                {{-- Rs {{ number_format($data->today_payment) }} --}}
                                <span class="text-success text-sm font-weight-bolder">+55%</span>
                            </h5>
                        </div>
                    </div>
        ...
        <div class="card">
            <div class="card-body p-3">
                <div class="row">
                    <div class="col-8">
                        <div class="numbers">
                            <p class="text-sm mb-0 text-capitalize font-weight-bold">Yesterdays's Balance</p>
                            <h5 class="font-weight-bolder mb-0">
                              @php
                                  try {
                                    echo 'Rs '.number_format($data->previousday_payment);
                                  } catch (Exception $e){
                                    echo 'Rs 0';
                                  }
                              @endphp
                                {{-- Rs {{ number_format($data->previousday_payment) }} --}}
                                <span class="text-success text-sm font-weight-bolder">+55%</span>
                            </h5>
                        </div>
                    </div>
