...
<div class="row">
            ...
            <form action="{{ route('purchases.update', $data->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="company_id" class="form-control" id="company_id">
                        ...
                        @if (old('customer_id', $data->company_id) == $company->id)
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" name="domestic10" value="{{ old('domestic10', explode(';', $data->remarks)[3]) }}" type="number" placeholder="Domestic Cylinders (10Kg)" id="domestic10">
                        @error('domestic10')
                        <span class="text-danger text-xs font-weight-bolder">{{ $message }}</span>
                        @enderror
                    </div>
  ...
  <script>
    ...
    function totalRate() {
        ...
        domestic6 = domestic6 == '' ? 0 : FloatInDigits(domestic6* 6);
        domestic10 = domestic10 == '' ? 0 : FloatInDigits(domestic10 * 10);
        others = others == '' ? 0 : FloatInDigits(others, 2);

        let totalgas = commercial + domestic + domestic6 + domestic10 + others;
        let total_rate = FloatInDigits(totalgas * rate);
